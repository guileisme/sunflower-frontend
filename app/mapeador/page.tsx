...
export default function MapeadorPage() {
  return (
    <main className="w-full bg-[#eeede8] min-h-screen font-sans pb-10">
      
      <header className="flex flex-col md:flex-row md:items-center justify-between border-b border-black/10 pb-5 gap-4 p-4 md:p-6 lg:p-8 bg-[#f9f9f7]">
        ...
        <Link href="/" className="text-[11px] font-black uppercase tracking-[0.15em] text-sun-green-600 hover:text-sun-green-700 transition-colors">
          ← Voltar ao Dashboard
        </Link>
      </header>
